...
Uses pymupdf4llm — preserves headers, tables, code blocks for LLM consumption.
...
def pdf_to_markdown(
    ...
    """
    Convert a PDF file to clean Markdown for LLM/RAG ingestion.

    Args:
        pdf_path:    Path to the input PDF file.
        output_path: Where to write the .md file. Defaults to same dir as PDF.
        pages:       Optional list of 0-based page numbers to convert.
    ...
    try:
        # pymupdf4llm preserves document structure for LLM use
...
def chunk_markdown(
    ...
    falls back to character-level splitting to respect chunk_size.
    ...
    Returns:
        List of dicts with keys: text, chunk_index, source.
    """
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python pdf_to_markdown.py <path/to/file.pdf>")
        sys.exit(1)
